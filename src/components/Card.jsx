...
const Card = () => {
  ...
  return (
    <div className="max-w-[300px] border border-slate-100 p-5 shadow-xl bg-white absolute top-40 right-[19rem] rounded-xl">
      ...
      <p className="text-xs font-sourceSans font-normal text-primary leading-normal">
